...
function StageColumn({
  ...
  return (
    ...
    <div 
      className="flex w-[85vw] min-w-[260px] max-w-[320px] shrink-0 snap-start flex-col rounded-xl border border-border bg-card p-4 lg:w-auto lg:max-w-none lg:flex-1 lg:basis-[260px] lg:shrink lg:snap-none transition-all duration-300"
      style={{
        borderTop: `4px solid ${stage.color}`,
        boxShadow: `0 -5px 15px -5px ${stage.color}4D`
      }}
    >
